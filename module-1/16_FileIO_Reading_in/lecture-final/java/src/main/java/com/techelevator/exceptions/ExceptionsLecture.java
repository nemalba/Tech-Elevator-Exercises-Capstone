...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		} catch(Exception e) { // If a NumberFormatException is thrown by Integer.parseInt(...) it will be
...
//		withdraw(currentBalance, amountToWithdraw);
		...
		try {
			...
			e.printStackTrace(); // will print the Exception stacktrace to the terminal  and ends the program ungracefully
		}
