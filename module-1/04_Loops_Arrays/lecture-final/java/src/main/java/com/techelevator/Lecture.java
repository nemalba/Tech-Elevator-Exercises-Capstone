...
public class Lecture {
    ...
    */
    //method header
    // public -- access modifier -- who can call this method? public means anyone can call
    // int [] -- data type of data being returned
    // returnArray -- name of method
    //   when declare a method, you always have () on the end
    // inside the () parens would be any values being passed in (parameters)
    public int[] returnArray() {
        // int[] array = new int[3]; -- all values will be 0
        int[] array = {80, 8080, 443}; // declaring and initializing the array all at once.
        return array;
    }
    ...
    */
    public int returnFirstElement() {
        ...
        return portNumbers[0];  // this will return the first value from the array
    }
    ...
    */
    public int returnLastElement() {
        int[] portNumbers = {80, 8080, 443};
        // arrayName.length will always give back the length of the array
//        return portNumbers[portNumbers.length - 1];
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
        return passedInArray[passedInArray.length - 1]; // index is always 1 less than the length!
    }
    ...
    */
    public boolean returnOperationInBlock() {
        ...
        // <-- Change the number to match result and make this be true
        return result == 50;
    ...
    */
    public boolean returnCorrectCount() {
        ...
        for (int i = 0; i < arrayToLoopThrough.length; i++) {
            ...
            // can do counter++  or counter-- -- can't use this shortcut to subtract 2  =>  counter -=2;
        }
