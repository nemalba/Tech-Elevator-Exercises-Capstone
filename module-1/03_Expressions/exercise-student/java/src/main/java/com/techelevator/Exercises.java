...
public class Exercises {
	...
	public boolean loneTeen(int a, int b) {
		...
		/*if((a<=13 && a<=19) || (b<=13 && b<=19) || (b<13 || 19)){
			return true;
		}*/
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
		...
		if((mealAmount>15 && !isBirthday) || (mealAmount>15 && isBirthday))
		{
			return "ginormous";
		}
		if(mealAmount==15 && isBirthday) {
			return "ginormous";
		}
