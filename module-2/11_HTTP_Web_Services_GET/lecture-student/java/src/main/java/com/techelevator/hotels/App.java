...
public class App {
    ...
    private void run() {
        ...
        while (menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                Hotel[] hotelList = hotelService.listHotels();
                consoleService.printHotels(hotelList);
               // System.out.println("Not implemented");
            } else if (menuSelection == 2) {
                Review[] reviewList = hotelService.listReviews();
                consoleService.printReviews(reviewList);
               // System.out.println("Not implemented");
