...
document.addEventListener('DOMContentLoaded', () => {
  ...
  desc.addEventListener('click', (event) => {
    ...
    //event.target in this function is desc in the DOM
  ...
  inputDesc.addEventListener('keyup', (event) => {
    ...
    // event handler code needs the event
    if (event.key === 'Enter') {
      //event.target will allow us to get the
      // new description that was typed into the inputDesc element
...
function toggleDescriptionEdit(desc) {
  ...
  // d-none is bootstrap and it says hide the content
  // remove d-none from the textbox
  textBox.classList.remove('d-none');
  //add d-none to the description
